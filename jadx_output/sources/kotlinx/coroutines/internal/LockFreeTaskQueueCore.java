...
public final class LockFreeTaskQueueCore<E> {
    ...
    public final <R> List<R> map(Function1<? super E, ? extends R> transform) {
        ...
        while (true) {
            int i3 = this.mask;
            if ((i & i3) != (i2 & i3)) {
                lIllIIIlIl1.lIIIIlllllIlll1 liiiilllllilll1 = (Object) this.array.get(i3 & i);
                if (liiiilllllilll1 != null && !(liiiilllllilll1 instanceof Placeholder)) {
                    arrayList.add(transform.invoke(liiiilllllilll1));
                }
                i++;
            } else {
                return arrayList;
