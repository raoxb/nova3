...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            m163constructorimpl = Result.m163constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m163constructorimpl = Result.m163constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m169isFailureimpl(m163constructorimpl) ? null : m163constructorimpl);
        ...
        try {
            Signal.handle(new Signal("TRAP"), new SignalHandler() { // from class: kotlinx.coroutines.debug.AgentPremain$$ExternalSyntheticLambda0
                public final void handle(Signal signal) {
                    AgentPremain.m1692installSignalHandler$lambda1(signal);
                }
            });
    ...
    public static final void m1692installSignalHandler$lambda1(Signal signal) {
