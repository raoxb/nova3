...
public final class StateFlowKt {
    ...
    public static final <T> T updateAndGet(MutableStateFlow<T> mutableStateFlow, Function1<? super T, ? extends T> function1) {
        lIllIIIlIl1.llllIIIIll1 lllliiiill1;
        T invoke;
        do {
            lllliiiill1 = (Object) mutableStateFlow.getValue();
            invoke = function1.invoke(lllliiiill1);
        } while (!mutableStateFlow.compareAndSet(lllliiiill1, invoke));
        return invoke;
    }
    ...
    public static final <T> void update(MutableStateFlow<T> mutableStateFlow, Function1<? super T, ? extends T> function1) {
        ...
        do {
            lllliiiill1 = (Object) mutableStateFlow.getValue();
        } while (!mutableStateFlow.compareAndSet(lllliiiill1, function1.invoke(lllliiiill1)));
    }
