            ...
            if (obj4 == obj) {
                ...
                if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater2, this, coroutine_suspended, obj3)) {
                    if (Result.m169isFailureimpl(result)) {
                        Continuation<R> continuation = this.uCont;
                        Throwable m166exceptionOrNullimpl = Result.m166exceptionOrNullimpl(result);
                        Intrinsics.checkNotNull(m166exceptionOrNullimpl);
                        Result.Companion companion = Result.INSTANCE;
                        if (DebugKt.getRECOVER_STACK_TRACES() && (continuation instanceof CoroutineStackFrame)) {
                            m166exceptionOrNullimpl = StackTraceRecoveryKt.recoverFromStackFrame(m166exceptionOrNullimpl, (CoroutineStackFrame) continuation);
                        }
                        continuation.resumeWith(Result.m163constructorimpl(ResultKt.createFailure(m166exceptionOrNullimpl)));
                        return;
                    }
        ...
        while (true) {
            ...
            if (obj4 == obj) {
                ...
                if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater2, this, coroutine_suspended, obj3)) {
                    ...
                    Result.Companion companion = Result.INSTANCE;
                    intercepted.resumeWith(Result.m163constructorimpl(ResultKt.createFailure(exception)));
                    return;
                }
            } else {
                throw new IllegalStateException("Already resumed");
