...
public interface ComparableTimeMark extends TimeMark, Comparable<ComparableTimeMark> {
    ...
    public static final class DefaultImpls {
        ...
        public static ComparableTimeMark m1485minusLRDsOJo(ComparableTimeMark comparableTimeMark, long j) {
            return comparableTimeMark.mo1482plusLRDsOJo(Duration.m1542unaryMinusUwyO8pc(j));
        }

        public static int compareTo(ComparableTimeMark comparableTimeMark, ComparableTimeMark other) {
            Intrinsics.checkNotNullParameter(other, "other");
            return Duration.m1489compareToLRDsOJo(comparableTimeMark.mo1481minusUwyO8pc(other), Duration.INSTANCE.m1592getZEROUwyO8pc());
        }
    }
}
