...
public abstract class AbstractDoubleTimeSource implements TimeSource.WithComparableMarks {
    ...
    private static final class DoubleTimeMark implements ComparableTimeMark {
        ...
        public long mo1479elapsedNowUwyO8pc() {
            return Duration.m1525minusLRDsOJo(DurationKt.toDuration(this.timeSource.read() - this.startedAt, this.timeSource.getUnit()), this.offset);
        }

        @Override // kotlin.time.TimeMark
        /* renamed from: plus-LRDsOJo, reason: not valid java name */
        public ComparableTimeMark mo1482plusLRDsOJo(long duration) {
            return new DoubleTimeMark(this.startedAt, this.timeSource, Duration.m1526plusLRDsOJo(this.offset, duration), null);
        }
        ...
        public long mo1481minusUwyO8pc(ComparableTimeMark other) {
            ...
            if (other instanceof DoubleTimeMark) {
                ...
                if (Intrinsics.areEqual(this.timeSource, doubleTimeMark.timeSource)) {
                    if (Duration.m1495equalsimpl0(this.offset, doubleTimeMark.offset) && Duration.m1522isInfiniteimpl(this.offset)) {
                        return Duration.INSTANCE.m1592getZEROUwyO8pc();
                    }
                    long m1525minusLRDsOJo = Duration.m1525minusLRDsOJo(this.offset, doubleTimeMark.offset);
        ...
        public boolean equals(Object other) {
            return (other instanceof DoubleTimeMark) && Intrinsics.areEqual(this.timeSource, ((DoubleTimeMark) other).timeSource) && Duration.m1495equalsimpl0(mo1481minusUwyO8pc((ComparableTimeMark) other), Duration.INSTANCE.m1592getZEROUwyO8pc());
        }

        @Override // kotlin.time.ComparableTimeMark
        public int hashCode() {
            return Duration.m1518hashCodeimpl(Duration.m1526plusLRDsOJo(DurationKt.toDuration(this.startedAt, this.timeSource.getUnit()), this.offset));
        }

        public String toString() {
            return "DoubleTimeMark(" + this.startedAt + DurationUnitKt.shortName(this.timeSource.getUnit()) + " + " + ((Object) Duration.m1539toStringimpl(this.offset)) + ", " + this.timeSource + ')';
        }
    }
