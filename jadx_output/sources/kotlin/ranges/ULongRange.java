...
public final class ULongRange extends ULongProgression implements ClosedRange<ULong>, OpenEndRange<ULong> {
    ...
    public /* bridge */ /* synthetic */ boolean contains(ULong uLong) {
        return m1412containsVKZWuLQ(uLong.getData());
    }

    @Override // kotlin.ranges.OpenEndRange
    public /* bridge */ /* synthetic */ ULong getEndExclusive() {
        return ULong.m332boximpl(m1413getEndExclusivesVKNKU());
    }

    @Override // kotlin.ranges.ClosedRange
    public /* bridge */ /* synthetic */ ULong getEndInclusive() {
        return ULong.m332boximpl(m1414getEndInclusivesVKNKU());
    }

    @Override // kotlin.ranges.ClosedRange
    public /* bridge */ /* synthetic */ ULong getStart() {
        return ULong.m332boximpl(m1415getStartsVKNKU());
    }
    ...
    public long m1413getEndExclusivesVKNKU() {
        ...
        return ULong.m338constructorimpl(getLast() + ULong.m338constructorimpl(1 & 4294967295L));
    }
    ...
    public int hashCode() {
        ...
        return (((int) ULong.m338constructorimpl(getFirst() ^ ULong.m338constructorimpl(getFirst() >>> 32))) * 31) + ((int) ULong.m338constructorimpl(getLast() ^ ULong.m338constructorimpl(getLast() >>> 32)));
    }

    @Override // kotlin.ranges.ULongProgression
    public String toString() {
        return ((Object) ULong.m384toStringimpl(getFirst())) + ".." + ((Object) ULong.m384toStringimpl(getLast()));
    }
